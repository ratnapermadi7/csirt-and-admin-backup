...
<body>
    ...
    <header>
        ...
        <img class="slider " src="{{asset('picture/tentangPerumnas.png')}}" alt="slider" width="100%">
        <div class="container">
            <section id="profile-part" class="profile-part pt-90 pb-90">
                ...
                <div class="row">
                    ...
                    @foreach($dataProfile as $data) @CSRF
