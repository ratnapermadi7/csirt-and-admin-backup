                            ...
                            <table class="table-borderless" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td>{{$row->judul}}</td>
                                            <td>{{$row->laporan}}</td>
                                            <td><a href="/dokumen/{{$row->file_pendukung}}"><button type="button"class="btn btn-info">Unduh File Pendukung</button></a></td>
                    
                                            <td><a href="/helpdesk/file_laporan{{$row->id}}"><button type="button"class="btn btn-info">Unduh Laporan</button></a></td>
